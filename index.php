...
for ($i=1; $i < 13; $i++)
{
    ...
    file_put_contents('logs/filmoteka.log', " Data: ".$date." - ".$log1." ".$imgType.PHP_EOL,FILE_APPEND);
    file_put_contents('posters/'.$i.".jpg", $img); 
    file_put_contents('logs/filmoteka.log', " Data: ".$date." - ".$log2." ".$imgType.PHP_EOL,FILE_APPEND);
}
// 3. Pobieramy ujęcia
for($i = 1; $i < 13; $i++)
{
